---
name: opsx-archive
description: Native Codex workflow for `opsx:archive`. Archive a completed change in the experimental workflow
---
...
1. **If no change name provided, prompt for selection**
   ...
   Run `openspec list --json` to get available changes. Use the **direct Codex user prompt** to let the user select.
...
5. **Update documentation (required)**
   ...
   Codex skill: `$ai-specs-update-docs` before archiving.
   `$ai-specs-update-docs` before archiving.
