...
description: Native Codex workflow for `ai-specs:new-us`. Start from Jira, Notion, or manual input. Enrich the user story, persist a canonical snapshot, optionally update Notion, and optionally create an OpenSpecs change.
---
