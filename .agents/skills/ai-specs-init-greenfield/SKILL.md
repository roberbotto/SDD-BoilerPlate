...
description: Native Codex workflow for `ai-specs:init-greenfield`. Generate definitive backend and frontend standards from templates for a new (greenfield) project
---
...
Codex skill: `$ai-specs-init-greenfield`
...
1. Use the available Codex MCP/app connector authentication flow for this repository.
2. Open the relevant Codex connector or MCP authentication surface.
...
Use the direct Codex user prompt to gather the necessary stack details.
