...
description: Native Codex workflow for `ai-specs:enrich-us`. Enrich a Base User Story into a deterministic, machine-parseable Enriched User Story and persist a canonical snapshot for handoff.
---
...
Codex skill: `$ai-specs-enrich-us`
