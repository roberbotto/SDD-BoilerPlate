...
description: Native Codex workflow for `opsx:bulk-archive`. Archive multiple completed changes at once
---
...
2. **Prompt for change selection**
   ...
   Use **direct Codex user prompt** with multi-select to let user choose changes:
...
7. **Confirm batch operation**
   ...
   Use **direct Codex user prompt** with a single confirmation:
